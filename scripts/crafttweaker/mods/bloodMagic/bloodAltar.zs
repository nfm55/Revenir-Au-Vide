...
mods.bloodmagic.BloodAltar.addRecipe(<contenttweaker:blood_tears> ,<minecraft:ghast_tear> ,  0 , 1000 , 50 , 5);
...
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:inscription_tool:6> ,<contenttweaker:rune_powder_of_dawn> ,  3 , 1000 , 50 , 5);
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:inscription_tool:5> ,<contenttweaker:rune_powder_of_twilight> ,  3 , 1000 , 50 , 5);
