...
BlockBuilder("mana_modularity_frame", <blockmaterial:iron>, <soundtype:metal>, 5.0, 50.0, "pickaxe", 2);
ResourceLocation.create("contenttweaker:mana_modularity_frame/mana_modularity_frame);